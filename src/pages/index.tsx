...
import LogoCarousel2 from '../components/LogoCarousel2.tsx'
...
import { logos, logosBugs, features, LHIntregrationExample, SetupExample, ComponentTestingExample } from '../constants.tsx'
        ...
        <Layout
            ...
            <header className={clsx('hero hero--primary', styles.heroBanner)} ref={ref}>
                <div className="container">
                    <h1 className="hero__title">
                        <img
                            src={useBaseUrl(siteConfig.themeConfig.image)}
                            alt="Hero"
                    ...
                    <div className={styles.buttons}>
                        ...
                        >
                            <Translate id="homepage.whyLazyFS">Why LazyFS?</Translate>
                        </Link>
                        <Link
                            to="https://github.com/dsrhaslab/lazyfs"
                            className={clsx(
                                'button button--outline button--secondary button--lg',
                                styles.getStarted,
                            )}
            ...
            <main>
                ...
                {/* <Section isDark={false}>
                    <LogoCarousel logos={logosBugs} mytitle="Systems tested with LazyFS"></LogoCarousel>
                </Section> */}
                <Section isDark={false}>
                    <LogoCarousel logos={logos} mytitle="Who used or is using LazyFS?"></LogoCarousel>
                </Section>
                {/* <Section>
                    <Sponsors />
                </Section> */}
